...
#> [zen4R][INFO] File downloaded at '/tmp/Rtmp2EFTwy'.
...
#> [5] readr_2.2.0      phylobar_0.99.12 dplyr_1.2.1      ape_5.8-1       
#> [9] BiocStyle_2.40.0
#> 
#> loaded via a namespace (and not attached):
#>  [1] fastmatch_1.1-8     xfun_0.59           bslib_0.11.0       
#>  [4] htmlwidgets_1.6.4   lattice_0.22-9      tzdb_0.5.0         
#>  [7] quadprog_1.5-8      vctrs_0.7.3         tools_4.6.1        
...
#> [19] compiler_4.6.1      textshaping_1.0.5   keyring_1.4.1      
...
#> [37] digest_0.6.39       purrr_1.2.2         bookdown_0.47      
#> [40] fastmap_1.2.0       grid_4.6.1          cli_3.6.6          
#> [43] magrittr_2.0.5      XML_3.99-0.23       utf8_1.2.6         
#> [46] withr_3.0.3         bit64_4.8.2         registry_0.5-1     
...
#> [61] BiocManager_1.30.27 xml2_1.6.0          vroom_1.7.1        
