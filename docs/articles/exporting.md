...
Não foi possível executar o JavaScript.
...
#> [1] phylobar_0.99.2  ape_5.8-1        BiocStyle_2.38.0
#> 
#> loaded via a namespace (and not attached):
#>  [1] Matrix_1.7-5        jsonlite_2.0.0      compiler_4.5.2     
#>  [4] BiocManager_1.30.27 Rcpp_1.1.1          parallel_4.5.2     
...
#> [25] xfun_0.57           quadprog_1.5-8      fs_2.0.1           
...
#> [37] nlme_3.1-168        vctrs_0.7.2         evaluate_1.0.5     
#> [40] codetools_0.2-20    ragg_1.5.2          purrr_1.2.1        
