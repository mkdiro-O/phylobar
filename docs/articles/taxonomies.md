...
#> [1] stringr_1.6.0    phyloseq_1.52.0  phylobar_0.99.0  dplyr_1.2.0     
...
#> [10] survival_3.8-6          magrittr_2.0.4          compiler_4.5.1         
#> [13] rlang_1.1.7             sass_0.4.10             tools_4.5.1            
#> [16] igraph_2.2.1            yaml_2.3.12             data.table_1.18.2.1    
#> [19] knitr_1.51              phangorn_2.12.1         htmlwidgets_1.6.4      
#> [22] plyr_1.8.9              RColorBrewer_1.1-3      withr_3.0.2            
#> [25] purrr_1.2.1             BiocGenerics_0.54.1     desc_1.4.3             
#> [28] grid_4.5.1              stats4_4.5.1            multtest_2.64.0        
#> [31] biomformat_1.36.0       Rhdf5lib_1.30.0         ggplot2_4.0.2          
#> [34] scales_1.4.0            iterators_1.0.14        MASS_7.3-65            
#> [37] cli_3.6.5               rmarkdown_2.30          vegan_2.7-2            
#> [40] crayon_1.5.3            ragg_1.5.0              generics_0.1.4         
#> [43] otel_0.2.0              httr_1.4.7              reshape2_1.4.5         
#> [46] cachem_1.1.0            rhdf5_2.52.1            splines_4.5.1          
#> [49] parallel_4.5.1          BiocManager_1.30.27     XVector_0.48.0         
#> [52] vctrs_0.7.1             Matrix_1.7-4            jsonlite_2.0.0         
#> [55] bookdown_0.46           IRanges_2.42.0          S4Vectors_0.48.0       
...
#> [67] UCSC.utils_1.4.0        quadprog_1.5-8          tibble_3.3.1           
#> [70] pillar_1.11.1           htmltools_0.5.9         rhdf5filters_1.20.0    
#> [73] GenomeInfoDbData_1.2.14 R6_2.6.1                textshaping_1.0.4      
#> [76] evaluate_1.0.5          lattice_0.22-9          Biobase_2.68.0         
#> [79] bslib_0.10.0            Rcpp_1.1.1              fastmatch_1.1-8        
#> [82] nlme_3.1-168            permute_0.9-10          mgcv_1.9-4             
#> [85] xfun_0.56               fs_1.6.6                pkgconfig_2.0.3
```
