...
data and time [`phylobar()`](../reference/phylobar.md). By default
`phylobar` sorts samples using hierarchical clustering, which can be
costly when the number of samples is large. It is also often unnecessary
when there is already a natural sample ordering (e.g., over time).
Setting `hclust_order = FALSE` keeps samples in their input order.
...
#> [1] phylobar_0.99.0  ggplot2_4.0.2    ape_5.8-1        BiocStyle_2.36.0
#> 
#> loaded via a namespace (and not attached):
#>  [1] sass_0.4.10         generics_0.1.4      lattice_0.22-9     
#>  [4] digest_0.6.39       magrittr_2.0.4      evaluate_1.0.5     
#>  [7] grid_4.5.1          RColorBrewer_1.1-3  bookdown_0.46      
#> [10] fastmap_1.2.0       jsonlite_2.0.0      Matrix_1.7-4       
#> [13] BiocManager_1.30.27 purrr_1.2.1         scales_1.4.0       
...
#> [25] tools_4.5.1         parallel_4.5.1      dplyr_1.2.0        
#> [28] fastmatch_1.1-8     vctrs_0.7.1         R6_2.6.1           
#> [31] lifecycle_1.0.5     fs_1.6.6            htmlwidgets_1.6.4  
#> [34] ragg_1.5.0          cluster_2.1.8.2     pkgconfig_2.0.3    
#> [37] desc_1.4.3          pkgdown_2.2.0       bslib_0.10.0       
#> [40] pillar_1.11.1       gtable_0.3.6        glue_1.8.0         
#> [43] phangorn_2.12.1     Rcpp_1.1.1          systemfonts_1.3.1  
#> [46] xfun_0.56           tibble_3.3.1        tidyselect_1.2.1   
#> [49] knitr_1.51          farver_2.1.2        htmltools_0.5.9    
#> [52] nlme_3.1-168        igraph_2.2.1        labeling_0.4.3     
#> [55] rmarkdown_2.30      compiler_4.5.1      quadprog_1.5-8     
#> [58] S7_0.2.1
```
