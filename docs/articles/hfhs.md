...
#> [1] stringr_1.6.0    ape_5.8-1        dplyr_1.2.0      phylobar_0.99.0 
#> [5] BiocStyle_2.36.0
#> 
#> loaded via a namespace (and not attached):
#>  [1] sass_0.4.10         generics_0.1.4      stringi_1.8.7      
#>  [4] lattice_0.22-9      digest_0.6.39       magrittr_2.0.4     
#>  [7] evaluate_1.0.5      grid_4.5.1          bookdown_0.46      
...
#> [25] parallel_4.5.1      fastmatch_1.1-8     png_0.1-8          
...
#> [43] systemfonts_1.3.1   xfun_0.56           tibble_3.3.1       
#> [46] tidyselect_1.2.1    knitr_1.51          htmltools_0.5.9    
#> [49] nlme_3.1-168        igraph_2.2.1        rmarkdown_2.30     
#> [52] compiler_4.5.1      quadprog_1.5-8
```
