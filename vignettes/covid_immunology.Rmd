...
In December 2020, while COVID-19 was still raging across the globe, [Su et al. ( 2020)](https://www.cell.com/cell/fulltext/S0092-8674(20)31444-6?_returnURL=https%3A%2F%2Flinkinghub.elsevier.com%2Fretrieve%2Fpii%2FS0092867420314446%3Fshowall%3Dtrue) published their pioneering study examining the immune and metabolic landscapes of mild to severe COVID patients. We took the single-cell RNA-seq (scRNA-seq) data from Su et al. (2020) to illustrate how phylobar enables us to visualise immune cell type composition changes along from milder to severer COVID-19.

See the [DIVAS project](https://byronsyun.github.io/DIVAS_COVID19_CaseStudy/) for a more comprehensive analysis of the COVID-19 data. Here we just took the cell type annotations to explore cell type compositions.
...
Load the cell and patient metadata.
