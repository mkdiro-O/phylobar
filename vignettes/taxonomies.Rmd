...
vignette: >
  %\VignetteIndexEntry{2. Building Trees from Taxonomies}
...
tables are often provided as output from microbiome sequencing pipelines or
extracted from Bioconductor containers such as
